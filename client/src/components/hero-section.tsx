  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 
          className="text-4xl md:text-6xl lg:text-7xl font-semibold hero-title-color mb-6"
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button 
            ...
            className="border-2 border-white bg-yellow-500 hover:bg-white hover:text-yellow-500 text-white px-8 py-4 text-lg font-semibold transition-all"
          ...
          <Button 
            ...
            variant="outline"
            className="border-2 border-white text-white bg-connection-color hover:bg-white hover:connection-color px-8 py-4 text-lg font-semibold transition-all"
